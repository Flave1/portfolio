...
import { NAME, DESIGNATION1, DESIGNATION2, SOCIAL_LINKS } from '../../../constants/constants';
import Favour from '../../../public/images/favour.jpg';
  ...
  return (
    <>
      ...
      <div className='headerr z-50 absolute bg-MidNightBlack backdrop-blur-sm inset-y-0 h-48 top-0 flex items-center justify-center w-full flex-col px-4 gap-y-4'>
        <Image className='mt-5 rounded-lg' src={Favour} alt='profile picture' />
        {/* <div className='flex flex-col items-center justify-center'>
          <span className='text-gray-300 text-base font-bold break-normal'>{NAME}</span>
          <span className='text-sm text-LightGray text-center mt-1'>{DESIGNATION1}</span>
          <span className='text-sm text-LightGray text-center mt-1'>{DESIGNATION2}</span>
        </div> */}
      </div>
